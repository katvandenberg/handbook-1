...
{\color{RosyBrown}\Large A Nice Tagline} \\ % Tagline or further description
{\color{LightGoldenrod}\resizebox*{\unitlength}{\baselineskip}{\rotlft{$\}$}}} % Print bottom curly bracket

\vfill % Whitespace between the title and the author name

{\Large{Taylor and Vandenberg}}\\ % AuthorS name
...
\end{itemize}
 ...
 %------Kathleen's Proofreading Section++++++++++++++++++
