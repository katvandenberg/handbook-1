...
A misplaced or dangling modifier occurs when a word or phrased is not placed next to 
the word it modifies, thus altering the meaning of a sentence, often in comical ways.
\begin{quote}
...
Mixed construction occurs when you start with one sentence structure and then shift 
to another.
\begin{quote}
\textbf{[Wrong]}: There is so much going on in the world today is why it is so hard to 
keep up with everything.

\textbf{[Revised]}: With so much going on in the world today, it is hard to keep up with 
everything.
\end{quote}
...
\emph{Mood} (indicative=make a statement/pose a question; imperative=request/command; 
subjunctive=making a wish):
\begin{quote}
...
\emph{With a nonrestrictive element} (a part of the sentence not essential to the 
